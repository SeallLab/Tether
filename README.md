...
Tether works well on Windows with minimal setup required:

#### Permissions

1. **Notifications**

   - Windows will automatically prompt you to allow notifications when Tether first runs
   - If you missed the prompt: Go to **Settings** > **System** > **Notifications**
   - Find **Tether** and ensure notifications are enabled

2. **Windows Defender/Antivirus** (if blocked)

   - If Windows Defender blocks Tether (unsigned app warning):
     - Go to **Windows Security** > **Virus & threat protection**
     - Click **Manage settings** under "Virus & threat protection settings"
     - Click **Add or remove exclusions**
     - Add the Tether installation folder as an exclusion

3. **Run at Startup** (recommended)

   - Go to **Settings** > **Apps** > **Startup**
   - Find **Tether** and toggle it **On**
   - This allows Tether to start automatically when you log in

#### Windows Installation Notes

- **Security Warnings**: Windows may show "Windows protected your PC" warnings
...
| ----------- | -------------- | ---------------------- |
| **macOS**   | `Cmd+Shift+D`  | Toggle dock visibility |
| **Windows** | `Ctrl+Shift+D` | Toggle dock visibility |
| **Linux**   | `Ctrl+Shift+D` | Toggle dock visibility |
